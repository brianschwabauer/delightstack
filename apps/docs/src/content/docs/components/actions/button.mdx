...
<Button loading_success>Success</Button>`}>
  <Button client:load disabled>Disabled</Button>
  <Button client:load loading>Loading</Button>
  <Button client:load loading_success>Success</Button>
</ComponentPreview>
...
| `loading_success` | `boolean` | `false` | Show checkmark success state manually |
