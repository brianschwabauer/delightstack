...
import ContextMenuCustomDemo from '../../../../components/demos/ContextMenuCustomDemo.svelte';
import ContextMenuPromiseDemo from '../../../../components/demos/ContextMenuPromiseDemo.svelte';
...
<ContextMenu />`}>
	<ContextMenuCustomDemo client:load />
</ComponentPreview>
...
<ContextMenu />`}>
	<ContextMenuPromiseDemo client:load />
</ComponentPreview>
