...
import ContextMenuIconsDemo from '../../../../components/demos/ContextMenuIconsDemo.svelte';
import ContextMenuLinksDemo from '../../../../components/demos/ContextMenuLinksDemo.svelte';
import ContextMenuActiveDemo from '../../../../components/demos/ContextMenuActiveDemo.svelte';
...
<ContextMenu />`}>
	<ContextMenuIconsDemo client:load />
</ComponentPreview>
...
<ContextMenu />`}>
	<ContextMenuLinksDemo client:load />
</ComponentPreview>
...
<ContextMenu />`}>
	<ContextMenuActiveDemo client:load />
</ComponentPreview>
