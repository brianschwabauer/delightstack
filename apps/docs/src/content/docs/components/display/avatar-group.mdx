...
import AvatarGroupSkeletonDemo from '../../../../components/demos/AvatarGroupSkeletonDemo.svelte';
...
<ComponentPreview code={`<AvatarGroup skeleton={loading} skeleton_count={4} avatars={loading ? [] : members} />`}>
	<AvatarGroupSkeletonDemo client:load />
</ComponentPreview>
