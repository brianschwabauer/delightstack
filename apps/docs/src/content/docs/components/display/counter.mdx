...
Digits flip individually like a mechanical counter with 3D transforms.

<ComponentPreview code={`<Counter value={42} animation="flip" />`}>
	<CounterDemo client:load value={42} animation="flip" />
</ComponentPreview>
...
| `animation` | `'count' \| 'flip'` | `'count'` | Animation style |
