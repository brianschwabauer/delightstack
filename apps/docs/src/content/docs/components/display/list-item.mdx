...
<ComponentPreview code={`<List type="text">
  ...
  <List client:load type="text">
    <ListItem client:load active>Currently Selected</ListItem>
    <ListItem client:load>Another Item</ListItem>
  </List>
</ComponentPreview>
...
<ComponentPreview code={`<List type="text">
  ...
  <List client:load type="text">
    <ListItem client:load disabled>Unavailable Action</ListItem>
    <ListItem client:load>Available Action</ListItem>
  </List>
</ComponentPreview>
