...
import QrSkeletonDemo from '../../../../components/demos/QrSkeletonDemo.svelte';
...
<ComponentPreview code={`<QR skeleton value={loading ? undefined : 'https://thedelight.co'} size={200} />`}>
  <QrSkeletonDemo client:load />
</ComponentPreview>
