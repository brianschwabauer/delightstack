...
Show a download button that exports the QR code as a PNG.

<ComponentPreview code={`<QR
${'  '}value="https://example.com"
${'  '}downloadable
${'  '}downloadFilename="my-share-code"
/>`}>
  <QR client:load value="https://example.com" downloadable downloadFilename="my-share-code" />
</ComponentPreview>
