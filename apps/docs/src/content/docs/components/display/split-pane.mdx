...
import SplitPaneSidebarDemo from '../../../../components/demos/SplitPaneSidebarDemo.svelte';
import SplitPaneVerticalDemo from '../../../../components/demos/SplitPaneVerticalDemo.svelte';
import SplitPaneCollapsibleDemo from '../../../../components/demos/SplitPaneCollapsibleDemo.svelte';
import SplitPaneNestedDemo from '../../../../components/demos/SplitPaneNestedDemo.svelte';
import SplitPaneSnapDemo from '../../../../components/demos/SplitPaneSnapDemo.svelte';
...
${'  '}{/snippet}
  ...
  <SplitPaneSidebarDemo client:load />
</ComponentPreview>
...
<ComponentPreview code={`<SplitPane vertical size={70}>
${'  '}{#snippet first()}
${'  '}${'  '}<div>Editor</div>
${'  '}{/snippet}
${'  '}{#snippet second()}
...
${'  '}{/snippet}
  ...
  <SplitPaneVerticalDemo client:load />
</ComponentPreview>
...
${'  '}{/snippet}
  ...
  <SplitPaneCollapsibleDemo client:load />
</ComponentPreview>
...
<ComponentPreview code={`<SplitPane size={20} collapsible>
${'  '}{#snippet first()}
${'  '}${'  '}<div>File Tree</div>
${'  '}{/snippet}
${'  '}{#snippet second()}
...
${'  '}{/snippet}
  ...
  <SplitPaneNestedDemo client:load />
</ComponentPreview>
...
<ComponentPreview code={`<SplitPane snap={[25, 50, 75]} snap_threshold={5}>
${'  '}{#snippet first()}
${'  '}${'  '}<div>Pane A</div>
${'  '}{/snippet}
${'  '}{#snippet second()}
