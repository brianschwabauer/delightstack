...
<ComponentPreview code={`<Stat value={1234} label="Total Users" />`}>
  <Stat client:load value={1234} label="Total Users" />
</ComponentPreview>
...
/>`}>
  <Stat client:load value="$12,450" label="Revenue" change={12.5} changeLabel="vs last month" />
</ComponentPreview>
...
<Stat value={42} label="Tasks" size="3" />`}>
  <Stat client:load value={42} label="Tasks" size="0" />
  <Stat client:load value={42} label="Tasks" size="1" />
  <Stat client:load value={42} label="Tasks" size="2" />
  <Stat client:load value={42} label="Tasks" size="3" />
</ComponentPreview>

### Horizontal Layout

<ComponentPreview code={`<Stat horizontal value="99.9%" label="Uptime" />`}>
  <Stat client:load horizontal value="99.9%" label="Uptime" />
</ComponentPreview>
...
/>`}>
  <Stat client:load value={23} label="Open Bugs" change={-15} trend="up" changeLabel="fewer than last week" />
</ComponentPreview>
