...
import StatSizesDemo from '../../../../components/demos/StatSizesDemo.svelte';
import StatSkeletonDemo from '../../../../components/demos/StatSkeletonDemo.svelte';
...
/>`}>
  <StatDemo client:load value={12450} prefix="$" label="Revenue" change={12.5} change_label="vs last month" />
</ComponentPreview>
...
/>`}>
  <StatDemo client:load value={23} label="Open Bugs" change={-15} trend="up" change_label="fewer than last week" />
</ComponentPreview>

### Skeleton Loading

<ComponentPreview code={`<Stat skeleton={loading} value={2451} label="Total Users" size="2" />`}>
  <StatSkeletonDemo client:load />
</ComponentPreview>
