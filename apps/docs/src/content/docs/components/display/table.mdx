---
title: Table
description: A full-featured data table with sorting, row selection, inline cell editing, custom cell rendering, column resizing, row grouping, expandable rows, and CSV/JSON export.
---
