...
<ComponentPreview code={`<Timeline>
  ...
  <Timeline client:load>
    <TimelineItem client:load title="Step 1" date="Jan 10" status="complete">
      First step completed.
    </TimelineItem>
    <TimelineItem client:load title="Step 2" date="Jan 11" status="active">
      Currently in progress.
    </TimelineItem>
    <TimelineItem client:load title="Step 3" status="pending" />
  </Timeline>
</ComponentPreview>
...
<ComponentPreview code={`<Timeline horizontal>
  ...
  <Timeline client:load horizontal>
    <TimelineItem client:load status="complete" title="Order Placed" />
    <TimelineItem client:load status="complete" title="Processing" />
    <TimelineItem client:load status="active" title="Shipping" />
    <TimelineItem client:load status="pending" title="Delivered" />
  </Timeline>
</ComponentPreview>
...
<ComponentPreview code={`<Timeline>
  ...
  <Timeline client:load>
    <TimelineItem client:load title="Custom Color" color="var(--color-error)">
      A red-themed event marker.
    </TimelineItem>
  </Timeline>
</ComponentPreview>
