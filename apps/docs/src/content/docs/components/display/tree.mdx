...
<Tree data={categories} checkboxes multiSelect bind:selected bind:expanded />`}>
...
<ComponentPreview code={`<Tree data={fileTree} showLines bind:expanded />`}>
...
<ComponentPreview code={`<Tree data={fileTree} dense showLines />

<Tree data={fileTree} comfortable showLines />`}>
	<TreeDensityDemo client:load />
</ComponentPreview>

### Skeleton Loading

<ComponentPreview code={`<Tree skeleton skeletonCount={6} skeletonDepth={3} />`}>
