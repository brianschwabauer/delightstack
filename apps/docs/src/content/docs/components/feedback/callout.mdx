...
import CalloutSkeletonDemo from '../../../../components/demos/CalloutSkeletonDemo.svelte';
...
<ComponentPreview code={`<Callout skeleton={loading}>…</Callout>`}>
	<CalloutSkeletonDemo client:load />
</ComponentPreview>
