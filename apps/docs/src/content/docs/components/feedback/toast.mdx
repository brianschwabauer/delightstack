...
import ToastActionDemo from '../../../../components/demos/ToastActionDemo.svelte';
import ToastDynamicPromiseDemo from '../../../../components/demos/ToastDynamicPromiseDemo.svelte';
import ToastPersistentDemo from '../../../../components/demos/ToastPersistentDemo.svelte';
import ToastCustomDurationDemo from '../../../../components/demos/ToastCustomDurationDemo.svelte';
import ToastDismissDemo from '../../../../components/demos/ToastDismissDemo.svelte';
...
<button onclick={handleSave}>Save File</button>`}>
  <ToastDynamicPromiseDemo client:load />
</ComponentPreview>
...
${'  '}Show Persistent Warning
  ...
  <ToastPersistentDemo client:load />
</ComponentPreview>
...
${'  '}8 Second Toast
  ...
  <ToastCustomDurationDemo client:load />
</ComponentPreview>
...
| `richColors` | `boolean` | `false` | Use saturated, variant-colored backgrounds |
| `id` | `string` | auto | Element ID |
| `class` | `string` | `''` | Additional CSS classes |

Toasts collapse into a stack (like [sonner](https://github.com/emilkowalski/sonner)) and fan out into a list on hover. Hovering also pauses auto-dismiss. Toasts can be swiped away with the pointer.
