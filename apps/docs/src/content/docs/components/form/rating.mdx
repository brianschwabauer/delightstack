...
<Rating bind:value={rating} precision={0.5} showValue />
```
...
```svelte
<Rating size="0" value={3} readonly />  <!-- 16px -->
<Rating size="1" value={3} readonly />  <!-- 24px (default) -->
<Rating size="2" value={3} readonly />  <!-- 32px -->
<Rating size="3" value={3} readonly />  <!-- 40px -->
```
