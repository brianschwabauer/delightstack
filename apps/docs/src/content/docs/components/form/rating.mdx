...
import RatingCustomDemo from '../../../../components/demos/RatingCustomDemo.svelte';
import RatingCustomMaxDemo from '../../../../components/demos/RatingCustomMaxDemo.svelte';
...
<ComponentPreview code={`<Rating bind:value={rating} max={10} showValue />`}>
	<RatingCustomMaxDemo client:load />
</ComponentPreview>
