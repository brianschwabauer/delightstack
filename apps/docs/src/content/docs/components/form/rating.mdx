...
<ComponentPreview code={`<Rating value={3.5} precision={0.5} show_value />`}>
	<Rating client:load value={3.5} precision={0.5} show_value />
</ComponentPreview>
...
<ComponentPreview code={`<Rating value={4.3} readonly show_value />`}>
	<Rating client:load value={4.3} readonly show_value />
</ComponentPreview>
...
<ComponentPreview code={`<Rating bind:value={rating} max={10} show_value />`}>
