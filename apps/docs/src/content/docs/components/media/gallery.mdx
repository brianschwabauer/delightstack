...
`sizing` adjusts how dense the thumbnails are. It changes column counts for grid/masonry, row heights for `masonry-row`, and row height for `list`.

<ComponentPreview code={`<Gallery {items} display="masonry" sizing="large" />`}>
	<GallerySizingDemo client:load />
</ComponentPreview>

### Spacing and radius

`spacing` controls the gap between items, and `radius` controls the corner radius. Both are tied to the same gallery-gap CSS variable so they scale together.

<ComponentPreview
	code={`<Gallery {items} display="grid" spacing="large" radius="large" />`}>
...
| `sizing`                  | `'small' \| 'default' \| 'large'`                 | `'default'`                  | Thumbnail density.                                                                                    |
| `spacing`                 | `'none' \| 'default' \| 'large'`                  | `'default'`                  | Gap between thumbnails.                                                                               |
| `radius`                  | `'none' \| 'small' \| 'large'`                    | `'small'`                    | Corner radius of thumbnails.                                                                          |
