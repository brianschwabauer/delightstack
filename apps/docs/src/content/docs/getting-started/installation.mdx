...
This page covers installing the **component library** into a Svelte 5 app. To set up the Cloudflare
backend packages instead, start with [Quick Start: Full Stack](/getting-started/quick-start-stack/).
...
- [Quick Start: Components](/getting-started/quick-start/) — Build a complete form example
