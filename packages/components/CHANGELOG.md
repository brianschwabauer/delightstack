...
- ddc93dc: Multi-select: a shared selection model
...
- 9f90d3f: Video: lazy poster loading via a new `lazy` prop (default `true`).
...
- e5e9c4d: Gallery: stop thumbnail load handlers from firing after their tile is destroyed.
