...
type DatabaseServerState = Omit<DatabaseSchema['state'], 'json'> & {
	json: {
...
export class DatabaseServer extends DurableObject {
	private sql = new SqlServer<EntityDatabaseSchema & DatabaseSchema>(this.ctx.storage);
	#org_id: string | undefined;
	#ws_id: DurableObjectId | undefined;
	#state: DatabaseServerState | undefined;
	#org: Org | undefined;
	...
	/** A record of search indexes that can be used to search using the Orama library */
	#indexes: DatabaseServerIndexes | undefined = undefined;
	...
	private async getIndex<EntityType extends keyof typeof ORAMA_CONFIG>(
		entity: EntityType,
	): Promise<undefined | DatabaseServerIndexes[EntityType]> {
		await this.initIndexes();
