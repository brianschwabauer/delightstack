...
export const icons = {
	...
	center: icon(
		'<circle cx="12" cy="12" r="3.5"/><path d="M12 2.5v3M12 18.5v3M2.5 12h3M18.5 12h3"/>',
	),
	crop_off: icon(
		'<path d="M6 6.6V16a2 2 0 0 0 2 2h9.4M9.6 6H16a2 2 0 0 1 2 2v6.4M6 2v2.6M6 6.6H2M18 18v4M18 18h4M2 2l20 20"/>',
	),
